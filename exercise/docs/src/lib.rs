...
//! though it does not possess a scientific definition and may be used in reference to many different squashes of varied appearance.
...
/// Big orange thing
/// # Recipes
/// the recipes will be coming soon.
pub struct Pumpkin {
    /// it is a percentage.
    pub roundness: f32,
